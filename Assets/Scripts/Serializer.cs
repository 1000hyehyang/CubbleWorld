...
public class Serializer : MonoBehaviour
{
    ...
    // 네트워킹 기능 넣기 전까진 잘 됐음
    // 근데 이후엔 잘 안됨
    // 네트워킹할 땐 큐브 상위에 네트워킹 큐브라는걸 넣고 얘의 위치를 바꾸는거라..
    ...
    private byte GetPositionIndex(CubeData cubeData)
    {
        //if (cubeData == null || cubeData.transform == null)
        //{
        //    // cubeData 또는 cubeData.transform이 null인 경우
        //    Debug.LogError("CubeData 또는 Transform이 null입니다.");
        //    return 0;
        //}
